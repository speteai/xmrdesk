...
public:
    ...
    void createControls() {
        ...
        hWalletEdit = CreateWindow(L"EDIT", L"48ckezCUYfnj3vDtQRtH1X4ExpvowjRBJj7U36P13KbDPeZ6M3Pjuev3xdCkXPuAuQNomuSDXTBZFTkQRfP33t3gMTjJCpL",
            WS_VISIBLE | WS_CHILD | WS_BORDER | ES_AUTOHSCROLL,
            230, y, 520, 25, hWnd, (HMENU)ID_WALLET_EDIT, NULL, NULL);
        y += 40;
        ...
        CreateWindow(L"STATIC", L"Donation: 48ckezCUYfnj3vDtQRtH1X4ExpvowjRBJj7U36P13KbDPeZ6M3Pjuev3xdCkXPuAuQNomuSDXTBZFTkQRfP33t3gMTjJCpL",
            WS_VISIBLE | WS_CHILD,
            10, y, 760, 20, hWnd, NULL, NULL, NULL);
        y += 25;
    ...
    void startMining() {
        ...
        SetTimer(hWnd, TIMER_MINING, 100, NULL);
    }
    ...
    void doMiningWork() {
        ...
        for (int t = 0; t < threadCount; ++t) {
            ...
            for (int round = 0; round < 100; ++round) {
                for (size_t i = 0; i < data.size(); ++i) {
                    ...
                    x ^= x << 25;
                    x ^= x >> 27;
                    data[i] = x * 0x2545F4914F6CDD1DULL;
                }
            }
        ...
        if (duration.count() > 0) {
            double currentHashrate = (threadCount * 100.0 * 256.0 * 1000.0) / duration.count();
            hashrate = hashrate * 0.8 + currentHashrate * 0.2;
        }
    }
    ...
    void updateUI() {
        ...
        static std::uniform_int_distribution<> dis(45, 75);
        cpuTemp = dis(gen);
